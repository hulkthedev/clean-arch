...
class MariaDbMapperTest extends TestCase
{
     ...
     */
    private function assertContract(Contract $contract): void
    {
     ...
     */
    private function assertPaymentAccount(PaymentAccount $paymentAccount): void
    {
     ...
     * @param array $objects
     */
    private function assertObjects(array $objects): void
    {
